function [all_data, subject_data_info] = get_raw_data_ADM(root, ids, groupdata, load_type)        
    all_data = cell(1, 1); 
    
    good_index = [];
    folder = [root 'rsmith/lab-members/cgoldman/adm/horizon/modeling_scripts_MUD_paper/data'];
