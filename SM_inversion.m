...
for i = 1:length(DCM.field)
    ...
    if ALL
        ...
        if ismember(field, {'learning_rate', 'learning_rate_pos', 'learning_rate_neg', 'noise_learning_rate', ...
                'starting_bias_baseline', 'starting_bias_action_prob_mod', 'starting_bias_reward_diff_mod', 'starting_bias_UCB_diff_mod', ...
                'drift_baseline', 'drift_action_prob_mod', 'drift_reward_diff_mod', 'drift_UCB_diff_mod', ...
                'alpha_start', 'alpha_inf', 'associability_weight'})
...
function L = spm_mdp_L(P,M,U,Y)
    ...
    for i = 1:length(field)
        if ismember(field{i},{'learning_rate', 'learning_rate_pos', 'learning_rate_neg', 'noise_learning_rate', ...
                'starting_bias_baseline', 'starting_bias_action_prob_mod', 'starting_bias_reward_diff_mod', 'starting_bias_UCB_diff_mod', ...
                'drift_baseline', 'drift_action_prob_mod', 'drift_reward_diff_mod', 'drift_UCB_diff_mod', ...
                'alpha_start', 'alpha_inf', 'associability_weight'})
