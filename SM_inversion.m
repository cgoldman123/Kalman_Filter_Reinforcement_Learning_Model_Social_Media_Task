...
for i = 1:length(DCM.field)
    ...
    if ALL
        ...
        elseif ismember(field, {'h1_dec_noise', 'h5_baseline_dec_noise', 'outcome_informativeness', 'sigma_d', ...
            ...
            pC{i,i}    = prior_variance;  
        elseif ismember(field,{'h5_baseline_info_bonus', 'h5_slope_info_bonus', 'h1_info_bonus','side_bias_h1', 'side_bias_h5', 'side_bias', ...
