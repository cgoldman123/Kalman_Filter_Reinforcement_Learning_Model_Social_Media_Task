...
for room in room_type:
    ...
    for index, model in enumerate(models, start=1):
        ...
        for subject in subjects:
            ...
            stdout_name = f"{combined_results_dir}/logs/SM-{model_class}-{room}_room-{subject}-%J.stdout"
            stderr_name = f"{combined_results_dir}/logs/SM-{model_class}-{room}_room-{subject}-%J.stderr"
            jobname = f'SM-{model_class}-{room}_room-{subject}'
...
# python3 /media/labs/rsmith/lab-members/cgoldman/Wellbeing/social_media/VB_scripts/runall_social.py /media/labs/rsmith/lab-members/cgoldman/Wellbeing/social_media/output/SM_fits_UCB_model_prolific "prolific"